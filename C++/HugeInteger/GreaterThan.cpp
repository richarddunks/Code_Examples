...
int main()
{
	...
	//function prototype
	bool isGreaterThanOrEqualTo( int opr1[], int opr2[] );
	void output( int opr[] );
	...
	operandFlag = isGreaterThanOrEqualTo( operand1, operand2 );
	if ( operandFlag == true ) 
	{
		cout << "The first operand is greater than or equal to the second." << endl;
	}
	else
	{
		cout << "The first operand is not greater than or equal to the second." << endl;
	} //end if
	//end test
	...
	operandFlag = isGreaterThanOrEqualTo( operand2, operand1 );
	if ( operandFlag == true ) 
	{
		cout << "The first operand is greater than or equal to the second." << endl;
	}
	...
	operandFlag = isGreaterThanOrEqualTo( operand1, operand3 );
	if ( operandFlag == true ) 
	{
		cout << "The first operand is greater than or equal to the second." << endl;
	}
	...
	operandFlag = isGreaterThanOrEqualTo( operand3, operand1 );
	if ( operandFlag == true ) 
	{
		cout << "The first operand is greater than or equal to the second." << endl;
	}
	...
	operandFlag = isGreaterThanOrEqualTo( operand2, operand3 );
	if ( operandFlag == true ) 
	{
		cout << "The first operand is greater than or equal to the second." << endl;
	}
	...
	operandFlag = isGreaterThanOrEqualTo( operand3, operand2 );
	if ( operandFlag == true ) 
	{
		cout << "The first operand is greater than or equal to the second." << endl;
	}
...
bool isGreaterThanOrEqualTo( int opr1[], int opr2[] )
{
	...
	//if i1 <= i2 opr1 is greater
	if ( opr1Index <= opr2Index )
	{
		return true; //opr1 is a larger number than opr2
	}
	else if ( opr1Index >= opr2Index )
	{
		return false; //opr1 is a smaller number than opr2
	}
